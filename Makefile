...
check: clean run_tests.o roman_arabic_map.o roman_calculator.o roman_to_arabic.o arabic_to_roman.o roman_validator.o roman_to_arabic_suite.o arabic_to_roman_suite.o roman_calculator_suite.o roman_validator_suite.o
