...
check: clean run_tests.o roman_arabic_map.o roman_calculator.o roman_to_arabic.o arabic_to_roman.o roman_validator.o roman_to_arabic_suite.o arabic_to_roman_suite.o roman_calculator_suite.o
	$(CC) -o $(BUILD)/run_tests $(BUILD)/run_tests.o $(BUILD)/roman_arabic_map.o $(BUILD)/roman_validator.o $(BUILD)/roman_calculator.o $(BUILD)/roman_to_arabic.o $(BUILD)/arabic_to_roman.o $(BUILD)/roman_to_arabic_suite.o $(BUILD)/roman_calculator_suite.o $(BUILD)/arabic_to_roman_suite.o -lcheck -pthread -lcheck_pic -lrt -lm -L./$(BUILD) -lroman_calculator
	$(BUILD)/run_tests
